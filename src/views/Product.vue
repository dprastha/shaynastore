                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs" v-if="productDetails.galleries.length > 0">
                                <carousel class="product-thumbs-track ps-slider" :nav="false" :dots="false" >
                                    ...
                                    class="pt" @click="changeImage(imageProduct.photo)" :class="imageProduct.photo == gambar_default ? 'active' : ''">
...
export default {
    ...
    methods: {
        ...
        setDataPicture(data) {
            ...
            // replace object productDetails dengan data dari API (galleries)
